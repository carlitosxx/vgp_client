...
CourseOpen courseOpenFromJson(String str) => CourseOpen.fromJson(json.decode(str));
...
class CourseOpen {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "sale_start": "${saleStart.year.toString().padLeft(4, '0')}-${saleStart.month.toString().padLeft(2, '0')}-${saleStart.day.toString().padLeft(2, '0')}",
        "sale_end": "${saleEnd.year.toString().padLeft(4, '0')}-${saleEnd.month.toString().padLeft(2, '0')}-${saleEnd.day.toString().padLeft(2, '0')}",
