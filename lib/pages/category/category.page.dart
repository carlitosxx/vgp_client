            ...
            builder: (context,state) {
              if (state is CategoryLoadingState) {
                return   const CustomScrollView(
                  slivers: [
                    SliverAppBar(title: Text('Seleccione un categoria'),),
                    SliverFillRemaining(
                      hasScrollBody: false,
              ...
              if (state is CategoryLoadedState){
                ...
                //todo:Generacion de la plantilla de categoria              
                 List<Widget> items= List.generate(listCategory.length,(i)=>InkWell(
                  splashColor: Colors.transparent,
                  highlightColor: Colors.transparent,
                  hoverColor: Colors.transparent,
                  onTap: (){
                    Navigator.of(context).pushNamed("/course-open",arguments: listCategory[i].id);
                  },
                   child: Container(      
                      ...
                      child: Column(
                        ...
                        children: [
                          FittedBox(
                            child: AutoSizeText(listCategory[i].name,
                              maxLines: 1,
                ...
                return CustomScrollView(
                  slivers: [
                    const SliverAppBar(title: Text('Seleccione un categoria'),),
                    SliverPadding(
