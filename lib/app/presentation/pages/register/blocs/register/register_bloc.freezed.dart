...
class _$RegisterLoad implements RegisterLoad {
  ...
  @override
  String toString() {
    return 'RegisterEvent.load(firstName: $firstName, lastName: $lastName, email: $email, password: $password)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return load(firstName, lastName, email, password);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return load?.call(firstName, lastName, email, password);
  }
...
abstract class RegisterLoad implements RegisterEvent {
  const factory RegisterLoad(final String firstName, final String lastName,
      final String email, final String password) = _$RegisterLoad;
...
mixin _$RegisterState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Register register) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Register register)? loaded,
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'RegisterState.loaded(register: $register)';
  }
...
abstract class _Loaded implements RegisterState {
  const factory _Loaded(final Register register) = _$_Loaded;
